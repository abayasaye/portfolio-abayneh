...
const BasePage = (props) => {
  const router = useRouter()
    const {indexPage, children, header, title = "Portfolio - Abayneh", metaDescription="My name is Abayneh Asaye and I am an experienced software engineer and freelance developer.", className=""} = props;
